public class Towers {
    ...
    // Constructor - the number of discs to use
    // Constructor calls a recursive method
    public Towers(int n) {
        this.numDiscs = n;
        // Move the number of discs from peg 1 to peg 3 using peg 2 as a temporary storage location
    ...
    private void moveDiscs(int num, int fromPeg, int toPeg, int tempPeg) {
        if (num > 0) {
            // Recursive call - creates another whole copy of the method in RAM
